...
-- INSERT INTO tasks (apt_id, title, from_user_id, to_user_id, due_date, message, karma) VALUES (1, 'Clean Gutter', 1, 2, '2018/04/13', '', 50);

-- INSERT INTO tasks (apt_id, title, from_user_id, to_user_id, due_date, message, karma) VALUES (1, 'Buy Toilet Paper', 3, 1, '2018/04/22', '', 10);

-- INSERT INTO tasks (apt_id, title, from_user_id, to_user_id, due_date, message, karma) VALUES (1, 'Clear Out Basement', 3, 1, '2018/04/23', 'need space for party!', 20);

-- INSERT INTO tasks (apt_id, title, from_user_id, to_user_id, due_date, message, karma) VALUES (1, 'Clean Microwave', 3, 1, '2018/04/25', '', 10);
...
INSERT INTO tasks (apt_id, title, from_user_id, to_user_id, due_date, message, karma) VALUES (1, 'Take Out The Trash', 1, 2, '2018/04/09', 'running low on trash bags', 10);

INSERT INTO tasks (apt_id, title, from_user_id, to_user_id, due_date, message, karma) VALUES (1, 'Empty Out The Fridge', 3, 1, '2018/04/13', 'rake is in the basement', 10);

INSERT INTO tasks (apt_id, title, from_user_id, to_user_id, due_date, message, karma) VALUES (1, 'Tidy Living Room', 4, 1, '2018/04/12', 'almost out of dish soap', 10);
...
INSERT INTO tasks (apt_id, title, message, cost, from_user_id, to_user_id, due_date, karma) VALUES (1, 'Pay Rent + Utilities', 'got the fancy tp :)', 1200, 1, 2, DATE '2018/04/14', 10);
...
INSERT INTO tasks (apt_id, title, message, cost, from_user_id, to_user_id, due_date, karma) VALUES (1, 'Reimburse Groceries', 'boughgt a bunch of brocolli', 14, 1, 3, DATE '2018/04/11', 10);
...
INSERT INTO goals_apartment (apt_id, from_user_id, title, message, karma) VALUES (1, 3, 'Friday Night Bar Hop', '', 500);

INSERT INTO goals_apartment (apt_id, from_user_id, title, message, karma) VALUES (1, 2, 'Brunch At Locanda Verde' , '', 250);
